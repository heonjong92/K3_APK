...
class TeachOCRFont : public CDialogEx
{
	DECLARE_DYNAMIC(TeachOCRFont)

public:
	TeachOCRFont(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~TeachOCRFont();

	enum { IDD = IDD_TEACH_OCR_FONT };
...
protected:
	...
	VisionProcess::LabelOCRData m_LabelData;
	...
	void SegmentFileDataLoad();
	void CheckImageNameFormat(CString strFilePath);
...
public:
	...
	afx_msg void OnCbnSelchangeFontteachComboOption1();
	afx_msg void OnCbnSelchangeFontteachComboOption2();
	afx_msg void OnCbnSelchangeFontteachComboOption3();
	afx_msg void OnCbnSelchangeFontteachComboOption4();
	afx_msg void OnCbnSelchangeFontteachComboOption5();

	afx_msg void OnBnClickedButtonRetryprev();
	afx_msg void OnBnClickedButtonRetrynext();

	afx_msg void OnBnClickedCheckManualTeachingMode();
	afx_msg void OnCbnSelchangeFontteachComboManualOption();

	afx_msg void OnBnClickedFontteachBtnManualOptionApply();
	afx_msg void OnBnClickedFontteachBtnManualOptionSave();
	afx_msg void OnBnClickedFontteachBtnManualOptionDelete();
};
